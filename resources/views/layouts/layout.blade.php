    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar"
            ...
            <div>
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand text-dark font-weight-bold d-flex align-items-center justify-content-center mt-4"
                    href="/" style="margin-top:20px">
                    <div class="sidebar-brand-icon ">
                        <img src="{{ asset('asset/img/poli.jpg') }}" width="120" style="margin-top:8px;">
                        {{-- <i class="fa fa-home"></i> --}}
                    </div>

                </a>

                <p class="ml-3 mt-4 text-center"><b>Sistem Poliklinik </b></p>
            </div>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <h4 class="text-dark font-weight-bold">Sistem Poliklinik</h4>
                            </div>
                        </div>
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('/asset/img/poli.jpg') }}">
                            </a>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Dibuat oleh Nurrohman Adi Wibawa<br> &copy; Sistem Poliklinik | Project Workshop Web
                        </span>
                    </div>
                </div>
            </footer>
