            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_hp" value="{{ $pasien->no_hp }}" class="form-control" id="no_hp"
                            required />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="no_rm" value="{{ $pasien->no_rm }}" class="form-control" id="no_rm"
                            required />
                    </div>
                </div>
            </div>
