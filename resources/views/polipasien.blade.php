...
<head>
    ...
    <style>
    body {
        background: url("{{ asset('asset/img/bg-home1.jpg') }}");
        object-fit: contain;
        background-size: 100%;
    ...
    <form action="{{ route('polipasien.simpan') }}" method="post" style="margin-top: 50px">
        ...
        <div class="card daftar  p-3">
            ...
            <fieldset>
                ...
                <div class="logo">
                    <img class="text-center mt-4" width="120px" src="{{ asset('asset/img/poli.jpg') }}" alt="logo rs">
                    <h5 class="text-center text-dark mt-2">Poliklinik</h5>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Masukan keluhan..." name="keluhan" id="keluhan"
                                rows="5"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="/" class="btn btn-success w-100 text-white mt-2">Kembali</a>
        ...
        <span class="text-dark text-center mt-2">Login sebagai Admin atau Dokter <a class="text-dark text-center mt-2"
                href="{{ route('login') }}"><b><u>Klik
                        disini</u></b></a></span> --}}
        </div>
    </form>
